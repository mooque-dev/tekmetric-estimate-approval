...
export default function TrustAnchor() {
  return (
    <section
      id="details"
      aria-label="Shop, vehicle and your reported concerns"
      className="scroll-mt-[var(--appbar-h)] border-b border-line"
    >
      <div className="mx-auto max-w-6xl px-5 pt-8 pb-7 sm:px-8 lg:pt-12">
        ...
        <div className="flex items-start justify-between gap-x-6 gap-y-1">
          <div className="flex items-center gap-3">
            <span
              aria-hidden
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-accent text-sm font-semibold tracking-tight text-paper"
            >
              IA
            </span>
            <div>
              <p className="font-semibold leading-tight text-ink">{shop.name}</p>
        ...
        {/* Headline */}
        <h1 className="mt-8 max-w-2xl text-[26px] font-semibold leading-[1.15] tracking-[-0.02em] text-ink sm:text-[34px]">
